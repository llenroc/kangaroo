	...
	public static class DataMapper
	{
		...
		public static DistributorsInfo PopulateDistributorInfo(IDataReader reader)
		{
			...
			else
			{
                ...
                //站点相关
                if (reader["SiteTel"] != System.DBNull.Value)
                {
                    distributorsInfo.SiteTel = (string)reader["SiteTel"];
                }
                if (reader["SiteRegionId"] != System.DBNull.Value)
                {
                    distributorsInfo.SiteRegionId = (int)reader["SiteRegionId"];
                }
                if (reader["SiteAddress"] != System.DBNull.Value)
                {
                    distributorsInfo.SiteAddress = (string)reader["SiteAddress"];
                }
                if (reader["SiteStatus"] != System.DBNull.Value)
                {
                    distributorsInfo.SiteStatus = (int)reader["SiteStatus"];
                }
                if (reader["SiteLat"] != System.DBNull.Value)
                {
                    distributorsInfo.SiteLat = (decimal)reader["SiteLat"];
                }
                if (reader["SiteLng"] != System.DBNull.Value)
                {
                    distributorsInfo.SiteLng = (decimal)reader["SiteLng"];
                }
