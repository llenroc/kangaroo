                                    ...
                                    <tr>
                                        <td colspan="8">
                                            <div class="mb10 table-operation">
                                                ...
                                                <asp:Button ID="btnDelete" runat="server" Text="删除" CssClass="btn resetSize btn-danger" OnClientClick="return HiConform('<strong>确定要执行删除操作吗？</strong><p>删除后商品将进入回收站，服务站点的相关商品也将被删除！</p>', this);" />
                                                &nbsp;︱
                                            ...
                                            <tr>
                                                ...
                                                <td width="7%">
                                                    ...
                                                    <p>
                                                        ...
                                                        <asp:Button ID="btnDel" CommandName="Delete" CommandArgument='<%# Eval("ProductId") %>' runat="server" CssClass="btnLink pad" Text="删除" OnClientClick="return HiConform('<strong>确定要执行删除操作吗？</strong><p>删除后商品将进入回收站，服务站点的相关商品也将被删除！</p>',this);" />
                                                    </p>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
