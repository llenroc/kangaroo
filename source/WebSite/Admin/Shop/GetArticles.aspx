...
<div class="page-header">
                ...
                <div class="mate-tabl" id="articleContainer">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" <%if(articletype==1){ %>class="active"<%} %>><a href="articles.aspx?articletype=1<%if(!string.IsNullOrEmpty(ArticleTitle)){%>&key=<%=Server.UrlEncode(ArticleTitle) %><%} %>">站点分享素材</a></li>
