...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function SendCard(obj) {
            ...
            DialogFrame("../settings/SendMilkCards.aspx?cardids=" + cardids, "发放奶卡", 800, 600, function () { location.href = "<%=localUrl%>"; });
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">
        <input type="hidden" runat="server" clientidmode="static" id="hidIsSite" />
      <div class="set-switch">
               <ul class="nav nav-tabs">
                    <li t="0" class="active"><a href="MilkCardManage.aspx?type=0">未发放</a></li>
                    <li t="2"><a href="MilkCardManage.aspx?type=2">已发放</a></li>
                    <li t="1"><a href="MilkCardManage.aspx?type=1">奶卡使用情况</a></li>
                </ul>

                        <div class="form-inline mb10" style="margin-top:20px">
                ...
                <a href="EditMilkCard.aspx" class="btn btn-info" role="hide">添加</a>
                            </div>
                              <div class="form-group">
     
                </div>
                            <div class="form-group mr20">  
                                    <a class="bl mb5"  onclick="reset()" style="cursor: pointer;" role="hide">清除条件</a>
                            </div>
                    </div>
        </div>
            ...
            <HeaderTemplate>
                <div>
                    <table class="table table-hover mar table-bordered" style="table-layout: fixed">
                        <thead>
                            <tr>
                                <button type="button" class="btn resetSize btn-primary " onclick="SendCard(this)" role="hide">发送奶卡</button>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".set-switch").find("[t='" + t + "']").siblings("li").removeClass("active");
            $(".set-switch").find("[t='" + t + "']").addClass("active");
        });
