        ...
        <div>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="home">
                    <div class="set-switch mt20" style="height:170px">
                        ...
                        <ul class="clearfix buyerInfo">
                            <li style="width: 375px;">
                                <p class="mb10"><span>姓名：</span><asp:Literal runat="server" ID="litRealName" /></p>
                                  <p class="mb10"><span>配送时间段：</span><asp:Literal runat="server" ID="litTime" /></p>
                                ...
                                <p class="mt10"><span>收货地址：</span><asp:Literal runat="server" ID="litShippingRegion"></asp:Literal></p>
                            </li>
                            <li>
                                <p class="mb10"><span>手机号：</span><asp:Literal runat="server" ID="litUserTel" /></p>
                                <p><span>配送天数：</span><asp:Literal ID="litDays" runat="server"></asp:Literal>天</p>
                                <p class="mt10"><span>买家留言：</span><asp:Literal ID="litRemark" runat="server"></asp:Literal></p>
                                 <p class="mt10"><span>订单总价：</span><asp:Literal ID="litOrerTotal" runat="server"></asp:Literal></p>
                            </li>
                            <li style="width: 306px;">
                                <p class="mb10"><span>用户名：</span><asp:Literal runat="server" ID="litUserName" /></p>
                                <p  class="mt10"><span>微信昵称：</span><asp:Literal runat="server" ID="litWeiXinNickName" /></p>
                                ...
                                <tr>
                                                            ...
                                                            <td width="450">
                                                                <div class="listInfoLeft">
                                                                    <div class="orderInfolist clearfix">
                                                                        ...
                                                                        <p class="fl orderP"><%# Eval("QuantityPerDay") %></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                    ...
                                    <td width="270" class="border">
                                        <div class="listInfoRight clearfix" style="padding: 0;">
                                            ...
                                            <div class="operation fr" style="text-align:center">
                                              <a style="cursor: pointer" href="../Fenxiao/questlist.aspx?action=lookorder&OrderId=<%=orderId %>">配送详情</a>
