                                                       ...
                                                       <td><%#Eval("RoleName") %></td>
                                                        <td>
                                                            <ul class="clearfix">
                                                                ...
                                                                <li <%#Eval("Msg6").ToString()!="1"? "style=\"display:none;\"" :"" %> >服务站点申请成功提醒</li>
                                                                    ...
                                                                    <div class="absol change">
                                                                        ...
                                                                        <div class="clearfix">
                                                                             <%--//固定列含义：1:新订单  2：订单付款  3：退款申请  4：用户咨询  5：提现申请   6：分销商申请成功--%>
                                                                                ...
                                                                                <label class="middle">
                                                                                    <asp:CheckBox runat="server" ID="cbMsg6" />服务站点申请成功
                                                                                </label>
                            ...
                            <div class="form-horizontal mb10">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        ...
                                        <label class="middle mb5 mr10">
                                            <asp:CheckBox runat="server" ID="cbMsg6" Text="服务站点申请成功提醒" />
                                        </label>
                                    </div>
                                </div>
                            </div>
