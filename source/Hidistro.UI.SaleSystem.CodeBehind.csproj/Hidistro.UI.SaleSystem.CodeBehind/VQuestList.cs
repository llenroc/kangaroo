...
namespace Hidistro.UI.SaleSystem.CodeBehind
{
	...
	public class VQuestList : VshopTemplatedWebControl
	{
		...
		protected override void AttachChildControls()
		{
            ...
            DistributorsInfo distributorinfo = DistributorsBrower.GetDistributorInfo(currentmember.ReferralUserId);
            if(distributorinfo != null)
            {
                this.litTel.Text = "<a  href='tel:"+ distributorinfo.SiteTel + "'>立即联系</a>";
            }
