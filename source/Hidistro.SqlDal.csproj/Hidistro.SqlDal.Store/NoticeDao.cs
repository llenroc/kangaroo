...
namespace Hidistro.SqlDal.Store
{
	public class NoticeDao
	{
		...
		public bool GetUserIsSel(int userid, string adminName, string frompage)
		{
		...
		public System.Data.DataSet GetSelectedUser(string adminName , string fromPage = "")
		{
