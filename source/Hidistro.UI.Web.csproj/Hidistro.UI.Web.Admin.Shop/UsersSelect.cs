...
namespace Hidistro.UI.Web.Admin.Shop
{
	public class UsersSelect : AdminPage
	{
		...
		protected UsersSelect() : base("m01", "00000")
		{
		}
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            this.fromPage = this.Page.Request.QueryString["page"];
            if (a == "sel")
			{
                ...
                this.fromPage = Globals.RequestFormStr("page");
                if (num == 1)
				{
				...
				{
					NoticeHelper.AddUser(userid, this.adminname,this.fromPage);
				}
