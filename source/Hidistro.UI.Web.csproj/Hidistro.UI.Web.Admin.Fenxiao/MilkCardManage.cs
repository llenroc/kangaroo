...
namespace Hidistro.UI.Web.Admin.Fenxiao
{
    public class MilkCardManage : AdminPage
    {
        ...
        protected HtmlInputHidden hidIsSite;
        public string type;
        ...
        private void BindData()
        {
            ...
            {
                query.status = int.Parse(this.type);
            }
        ...
        private MilkCardQuery GetMilkCardQuery()
        {
            ...
            if (currentManager.SiteId > 0)
            {
                query.siteId = currentManager.SiteId;
                this.hidIsSite.Value = query.siteId.ToString();
            }
