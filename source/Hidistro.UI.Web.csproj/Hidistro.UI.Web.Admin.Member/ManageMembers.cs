	...
	public class ManageMembers : AdminPage
	{
		...
		private void LoadParameters()
		{
			if (!this.Page.IsPostBack)
			{
                ...
                if (ManagerHelper.GetCurrentManager() != null && ManagerHelper.GetCurrentManager().RoleId == 16) //临时修改
                {
                    DistributorsInfo entity = VShopHelper.GetUserIdDistributors(ManagerHelper.GetCurrentManager().SiteId);
